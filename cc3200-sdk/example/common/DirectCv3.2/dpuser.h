 ...
 * 
 */
#define CLK_US_LOOP             16ul
 
#define JTAG_GPIOAX_BASE        GPIOA0_BASE

#define TCK                     GPIO_PIN_4
#define TDI                     GPIO_PIN_5
#define TMS                     GPIO_PIN_3
#define TRST                    GPIO_PIN_7 // can be set to 0
#define TDO                     GPIO_PIN_6
#define JTAG_GPIO_PIN_VAL(pin)  HWREG(JTAG_GPIOAX_BASE + (GPIO_O_GPIO_DATA + ((pin) << 2)))
